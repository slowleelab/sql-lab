...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'SQL Lab · 94 个能跑的 MySQL/TiDB 优化实战案例' }],
    ['meta', { property: 'og:description', content: '一套能跑、能量化对比的 MySQL 优化实战案例集。94 个精选案例，8 大场景，覆盖 MySQL 5.7/8.0 和 TiDB，Docker 一键复现，bad/good EXPLAIN 量化对比。' }],
    ...
    ['meta', { name: 'twitter:title', content: 'SQL Lab · 94 个能跑的 MySQL/TiDB 优化实战案例' }],
